/**
 * Generalize an-attribute of a-specific-concept.
 * In current-concept[a] add an-attribute which is attribute
 * of a-specific of it[a].
 *
 *
 * Input: Ask for current-concept's path.
 * Output:
 * run: node js-mcsAttSpcAdd.js
 *
 * version.0-1-0.2017-10-14,
 */
