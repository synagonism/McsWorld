/**
 * Create filMcsName.last.html with Steemit-comments.
 *
 * Input:
 * Output: filMcsName.last.html file.
 * run: node js-mcsAdd2.js
 *
...
s =
  ...
  '  <meta name="keywords" content="' + sN + ', ' + sNS + ', ModelConceptStructured, Mcs, Synagonism">\n' +
...
s = s +
  ...
  '    <br>• version.0-1-0.' + moUtil.fDateYMD() + '.created: filMcs' + sNFil + '.0-1-0.' + moUtil.fDateYMD() + '.html,\n' +
